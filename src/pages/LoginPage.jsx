  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-app-bg to-white px-4">
      <form onSubmit={onSubmit} className="card-surface w-full max-w-md p-8">
        ...
        <input required placeholder="Username" className="mb-3 w-full rounded-xl border border-emerald-100 px-4 py-2.5 outline-none" />
        <input required type="password" placeholder="Password" className="mb-4 w-full rounded-xl border border-emerald-100 px-4 py-2.5 outline-none" />
        <button className="w-full rounded-xl bg-primary px-4 py-2.5 font-medium text-white transition hover:bg-emerald-600">Sign In</button>
