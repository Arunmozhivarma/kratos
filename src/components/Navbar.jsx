            ...
            {showProfile && (
              <div className="absolute right-0 mt-2 w-44 rounded-xl border border-emerald-100 bg-white p-2 shadow-soft dark:border-gray-600 dark:bg-gray-800">
                <Link
                  ...
                  className="flex w-full items-center gap-2 rounded-lg px-2 py-2 text-left text-sm text-gray-700 hover:bg-emerald-50 dark:text-gray-200 dark:hover:bg-gray-700"
                >
                  <UserCircle2 size={16} />
                  View Profile
                </Link>
